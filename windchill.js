function decideConvert(temp, ws) {
     ...
     if (document.Convert.windunit[0].checked) {
          ...
          if (ws > 1000) {
               alert('A Wind Chill value cannot be calculated for wind speeds greater than 1609 kilometers/hour');
               document.Convert.windspeed.value = "";
               return 0;
          }
     }
     ...
     if (document.Convert.windunit[1].checked) {
          ...
          if (ws > 1000) {
               alert('A Wind Chill value cannot be calculated for wind speeds greater than 447 meters/second');
               document.Convert.windspeed.value = "";
               return 0;
          }
     }
     ...
     if (document.Convert.windunit[3].checked) {
          ...
          if (ws > 1000) {
               alert('A Wind Chill value cannot be calculated for wind speeds greater than 869 Knots');
               document.Convert.windspeed.value = "";
               return 0;
          }
     }
     ...
     if (document.Convert.tempunit[0].checked) {
          ...
          if (ws > 1000) {
               alert('A Wind Chill value cannot be calculated for wind speeds greater than 1000 miles/hour');
               document.Convert.windspeed.value = "";
               return 0;

          }
          if (F > 104) {
               alert('A Wind Chill value cannot be calculated for temperatures greater than 40.0 degrees Celsius.');
     ...
     if (document.Convert.tempunit[1].checked) {
          ...
          if (temp > 50) {
               alert('A Wind Chill value cannot be calculated for temperatures greater than 104 degrees Fahrenheit.');
               document.Convert.Fahr.value = "";
               document.Convert.Cels.value = "";
               document.Convert.Temp.value = "";
          }
